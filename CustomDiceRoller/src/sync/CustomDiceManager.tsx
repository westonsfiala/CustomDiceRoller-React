...
export default class CustomDiceManager {
    ...
    static mInstance = null as CustomDiceManager;

    mDice = this.standardDice as Array<Die>;
    mUpdater = null

    static getInstance() : CustomDiceManager {
        if(CustomDiceManager.mInstance === null) {
            CustomDiceManager.mInstance = new CustomDiceManager();
        }
